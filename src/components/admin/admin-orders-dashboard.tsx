      ...
      <header className="admin-page-header">
        <div>
          ...
          <div className="mt-2 flex flex-wrap items-center gap-3">
            <h1 className="admin-page-title mt-0" id="orders-dashboard-heading">Website orders</h1>
            <span className="admin-source-badge">Website · Square read only</span>
          </div>
          <p className="admin-lede">Sales and refunds generated by this website only. In-store and Square POS activity is excluded.</p>
        </div>
