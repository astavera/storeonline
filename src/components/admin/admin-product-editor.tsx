      ...
      <div className="admin-product-editor-grid">
        ...
        <section className="admin-product-settings" aria-label="Website product settings">
            ...
            <div className="admin-product-form-grid">
              <EditorField label="Website categories">
                {categories.length > 0 ? (
                  ...
                  />
                ) : <ConfigurationLink href="/admin/product-placement#structure-categories" label="Create website categories first" />}
              </EditorField>
              <EditorField label="Brands">
                {brands.length > 0 ? (
                  ...
                  />
                ) : <ConfigurationLink href="/admin/product-placement#structure-brands" label="No website brands configured" />}
              </EditorField>
            </div>
          </EditorSection>
          ...
          <EditorSection description="Optional date-bound placements for active holiday collections." title="Campaigns">
            ...
            ) : <ConfigurationLink href="/admin/product-placement#structure-holidays" label="No holiday campaigns configured" />}
          </EditorSection>
