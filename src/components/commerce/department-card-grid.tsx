...
RELATED FILES: src/config/departments.config.ts, src/config/navigation.config.ts
        ...
        .map((department) => (
          <Link className="group surface-card overflow-hidden" href={`/${department.slug}`} key={department.slug}>
            <div className="aspect-[4/3] bg-surface-muted">
              <img alt="" className="h-full w-full object-cover transition duration-300 group-hover:scale-[1.03]" src={department.hero_image_url} />
            </div>
            <div className="p-4">
