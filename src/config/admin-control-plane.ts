...
export const adminModules: AdminModule[] = [
  ...
  },
  {
    ...
    purpose: "Place one Square product in many website sections: departments, holidays, balloons, homepage rails, search groups, and promos.",
    productionGoal: "Merchandise products anywhere online without changing Square categories.",
    riskLevel: "critical",
