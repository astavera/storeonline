/**
 * Defines the editable homepage section model, presets, and default content.
 */
...
export const backToSchoolHomepageImage = "/images/homepage/home-hero-back-to-school-ecommerce-wireframe.svg";
...
export const homepageSections: HomepageSectionConfig[] = [
  {
    ...
    items: [
      { id: "halloween-slide-1", title: "Halloween Headquarters", body: "Costumes, decorations, candy and party-night surprises.", href: "/holidays/halloween", image: "/images/homepage/halloween-hero-01-bg.png", imageAlt: "Spiderwebs, a witch crossing an orange moon, and a haunted house", linkType: "page", linkValue: "halloween" },
      { id: "halloween-slide-2", title: "Happy Halloween", body: "Get the best costumes, decorations, accessories and candy in all of NYC.", href: "/holidays/halloween", image: "/images/homepage/halloween-hero-02-bg.png", imageAlt: "A purple Halloween night with a witch, ghost, pumpkin, bat and black cat", linkType: "page", linkValue: "halloween" },
      { id: "halloween-slide-3", title: "Your Halloween Headquarters", body: "Everything for a frightfully fun celebration, all in one place.", href: "/holidays/halloween", image: "/images/homepage/halloween-hero-03-bg.png", imageAlt: "A dancing skeleton and stacked pumpkins beneath a canopy of spiderwebs", linkType: "page", linkValue: "halloween" }
    ]
  },
  {
  ...
  {
    sectionId: "home.seasonal-products-row-1",
    ...
    columns: 4,
    categorySlug: "",
    hiddenElements: ["eyebrow", "body"],
    items: []
  },
  {
    sectionId: "home.seasonal-products-row-2",
    sectionType: "feature-grid",
    title: "Seasonal Category 2",
    body: "",
    variant: "seasonal-product-carousel",
    sortOrder: 22,
    isVisible: true,
  ...
  {
    sectionId: "home.seasonal-products-row-3",
    sectionType: "feature-grid",
    title: "Seasonal Category 3",
    body: "",
    variant: "seasonal-product-carousel",
    sortOrder: 23,
    isVisible: true,
  ...
  },
  {
    ...
    ctaHref: "/shop?feature=new-and-trending",
  ...
  },
  {
    ...
    sectionType: "promo",
    eyebrow: "Party supplies",
    title: "Set the table. Start the party.",
    body: "Shop colorful tableware, decorations, candles, favors, and more.",
    ctaLabel: "Shop Party Supplies",
    ctaHref: "/party-supplies",
    variant: "party-supplies-callout",
    sortOrder: 25,
    isVisible: true,
    backgroundImage: "/images/homepage/party-supplies-callout.jpg",
    imageAlt: "Colorful party plates, napkins, cups, and cupcakes arranged for a celebration",
  ...
  },
  {
    ...
    verticalPadding: "compact",
    columns: 3,
    hiddenElements: ["eyebrow", "body", "primaryCta"],
    items: []
  },
  {
    ...
    sectionType: "promo",
    eyebrow: "Toys",
    title: "Big imaginations start here.",
    body: "Discover colorful toys, puzzles, games, plush friends, and creative play for every age.",
    ctaLabel: "Shop Toys",
    ctaHref: "/toys",
    variant: "toys-callout",
    sortOrder: 27,
    isVisible: true,
    backgroundImage: "/images/homepage/toys-callout-istock.webp",
    imageAlt: "Child playing with colorful wooden sorting toys on a tabletop",
    mediaPlacement: "right",
    placeholderLayout: "split",
    backgroundTone: "dark",
    contentWidth: "wide",
    ...
    columns: 2,
    items: [
      { id: "all-toys", title: "Shop All Toys", href: "/toys", linkType: "page", linkValue: "/toys", tone: "cyan" },
      { id: "toys-by-age", title: "Shop By Age", href: "/shop?department=toys", linkType: "manual", tone: "yellow" },
      { id: "trending-toys", title: "Shop Trending", href: "/shop?department=toys&feature=new-and-trending", linkType: "manual", tone: "red" }
    ]
  },
  {
    sectionId: "home.toy-categories",
    sectionType: "feature-grid",
    title: "Shop By Category",
    body: "",
    variant: "toy-category-carousel",
    sortOrder: 28,
    isVisible: true,
    mediaPlacement: "none",
    placeholderLayout: "rail",
