...
const envSchema = z.object({
  ...
  STOREFRONT_ADMIN_PREVIEW: z.enum(["true", "false"]).default("false"),
  ...
  SQUARE_CATALOG_SYNC_MAX_AGE_SECONDS: z.coerce.number().int().min(60).max(86_400).default(86_400),
  SQUARE_INVENTORY_SYNC_MAX_AGE_SECONDS: z.coerce.number().int().min(60).max(86_400).default(1_800),
  ...
  ADMIN_IDENTITY_MODE: z.enum(["LEGACY_BOOTSTRAP", "DATABASE"]).default("LEGACY_BOOTSTRAP"),
  ADMIN_MFA_ENCRYPTION_KEY: z.preprocess((value) => value === "" ? undefined : value, z.string().min(1).optional()),
  ADMIN_RECOVERY_CODE_PEPPER: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional()),
  ADMIN_PUBLIC_URL: z.preprocess((value) => value === "" ? undefined : value, z.string().url().optional()),
  ADMIN_PASSWORD_RESET_EMAIL_FROM: z.preprocess((value) => value === "" ? undefined : value, z.string().min(3).optional()),
  ...
  ORDERPRO_STOREFRONT_FULFILLMENT_BASE_URL: z.preprocess((value) => value === "" ? undefined : value, z.string().url().optional()),
  ORDERPRO_STOREFRONT_FULFILLMENT_AUTH_MODE: z.enum(["AUTH0", "SHARED_SECRET"]).optional(),
  ORDERPRO_STOREFRONT_FULFILLMENT_AUTH0_SCOPES: z.string().optional(),
  ORDERPRO_STOREFRONT_PICKUP_QUOTE_SHARED_SECRET: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional()),
  ORDERPRO_STOREFRONT_PICKUP_RESERVATION_SHARED_SECRET: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional()),
  ORDERPRO_STOREFRONT_DURABLE_QUOTE_SHARED_SECRET: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional()),
  ORDERPRO_STOREFRONT_WALKING_RESERVATION_SHARED_SECRET: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional()),
  ORDERPRO_STOREFRONT_CAPACITY_CHECKOUT_SHARED_SECRET: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional()),
  ...
  ORDERPRO_STOREFRONT_CHECKOUT_BASE_URL: z.preprocess((value) => value === "" ? undefined : value, z.string().url().optional()),
  ORDERPRO_STOREFRONT_CHECKOUT_SHARED_SECRET: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional()),
  ...
  ADMIN_TRANSACTIONAL_NOTIFICATION_PROVIDER: z.enum(["DISABLED", "RESEND"]).default("DISABLED")
});
